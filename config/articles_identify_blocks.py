...
tfrec_train_pattern = 'gs://arcanum-ml/cv/articles/deeplab/tfrecords-identify-blocks-train/*'
tfrec_val_pattern = 'gs://arcanum-ml/cv/articles/deeplab/tfrecords-identify-blocks-val/*'
model_dir = 'gs://arcanum-ml/cv/articles/deeplab/model-identify-blocks'
log_dir = 'gs://arcanum-ml/cv/articles/deeplab/model-identify-blocks/logs'
...
CONFIG = {
    ...
    'strategy': 'tpu',
    'mode': 'gcp',
    'tpu_name': 'deeplab-identify-blocks',
    'num_classes': 2,
    'backbone': 'resnet50',
