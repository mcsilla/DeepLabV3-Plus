...
model_dir = 'gs://arcanum-ml/cv/articles/deeplab/model-without-encyclopedias-with-validation-1024/article-segmentation'
log_dir = 'gs://arcanum-ml/cv/articles/deeplab/model-without-encyclopedias-with-validation-1024/article-segmentation/logs'
