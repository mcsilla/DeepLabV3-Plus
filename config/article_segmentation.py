...
model_dir = 'gs://arcanum-ml/cv/articles/deeplab/model-no-encyclopedias-with-random-validation/article-segmentation'
log_dir = 'gs://arcanum-ml/cv/articles/deeplab/model-no-encyclopedias-with-random-validation/article-segmentation/logs'
